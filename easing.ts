...
namespace ease.blocks {
     ...
     */
    //% blockId=easeAnimateOnCurve
    //% block="do animation with name $name from $startValue to $endValue duration $durationMs ms on curve $curveType with easing $easeType with repeat $repeatMode"
    //% name.defl="my anim"
    //% endValue.defl=1
    //% duration.defl=1000
